// < 12-1. call by value, call by reference >
// 콜바이~들은 인자와 매개변수간의 관계를 의미한다.
// 원시값은 복사가 돼서 매개변수에 들어간다.
// call by reference는 자바스크립트에 없다! 포인터 같은게 아니다.
// 객체 속성 수정 시에는 참조이지만 객체 자체를 수정할 시에는 관계가 깨진다.


// < 12-2. 생성자와 new >
// 생성자 함수에서 대문자는 필수는 아니지만 약속이다.
// this는 기본적으로 window이고 strict모드에서는 undefined이다.


// < 12-3. 자스스톤 화면 세팅>

// cloneNode로 기존 태그를 그대로 복사 가능하다. 인자에 true를 넣으면 내부까지 다복사!
